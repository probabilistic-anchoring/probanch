...
public:
  ...
  : nh_(nh) 
  , viewer_ ("PCL Tracking Viewer")
  , new_cloud_ (false)
  , ne_ (8)
  , counter_ (0)
  , use_convex_hull_ (true)
  , visualize_non_downsample_ (true)
  , visualize_particles_ (true)
  , downsampling_grid_size_ (0.01)
  {
    ...
    // Init the PCL viewer
    viewer_.runOnVisualizationThread (boost::bind(&ObjectTracking::viz_cb, this, _1), "viz_cb");

    // Create a ROS subscriber for the input point cloud
    sub_ = nh_.subscribe ("cloud", 1, &ObjectTracking::cloud_cb, this);
  ...
  // --------------------------------
  // Filter, segmentation & tracking functions
  // ----------------------------------------------
...
main (int argc, char** argv)
{
  ...
  ObjectTracking<pcl::PointXYZRGBA> node(nh);
  node.spin();
  return 0;
}
