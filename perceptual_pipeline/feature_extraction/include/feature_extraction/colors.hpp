...
#define COLOR_NAMES_MAX 866
#define COLOR_SHADES_MAX 13
...
//const int color_shade_numbers[COLOR_SHADES_MAX] = { 28, 19, 12, 26, 24, 46, 52, 43, 36, 63, 21, 62, 23 };
const int color_shade_numbers[COLOR_SHADES_MAX] = { 28, 19, 12, 26, 35, 46, 52, 43, 36, 63, 17, 62, 23 };
const std::string color_shade_names[COLOR_SHADES_MAX] = { "white", "gray", "black", "magenta", "pink", "red", "brown", "orange", "yellow", "green", "cyan", "blue", "violet" }; 
