...
int main(int argc, char **argv) {
  ...
  model_path = ROOT_SAMPLE + "/model/deploy.prototxt";
  weights_path = ROOT_SAMPLE + "/model/bvlc_reference_caffenet.caffemodel";
  mean_file = ROOT_SAMPLE + "/model/imagenet_mean.binaryproto";
  label_file = ROOT_SAMPLE + "/model/synset_words.txt";
  image_path = ROOT_SAMPLE + "/model/test.jpg";
